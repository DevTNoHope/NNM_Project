...
const ProjectsPage = () => {
  ...
  useEffect(() => {
    getProjects().then(r => { setAll(r.data); setLoading(false); });
  }, []);
    ...
    <div className="projects-page">
      <div className="projects-hero">
        <div className="container">
          ...
          <p className="projects-hero__sub">Support verified, impactful causes from around the world.</p>
          <SearchBar
      ...
      <div className="projects-body container">
        {loading ? <Spinner center size="lg" /> : (
          <>
            <ProjectFilters filters={filters} onChange={handleFilters} resultCount={filtered.length} />
            {filtered.length === 0 ? (
